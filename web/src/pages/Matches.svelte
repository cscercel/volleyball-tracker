  ...
  function toggleBlue(name: string) {
  ...
  function toggleRed(name: string) {
    if (redTeam.includes(name)) {
          ...
          <div class="team">
            ...
            {#each players as player}
              <label>
                <input
                  type="checkbox"
                  checked={blueTeam.includes(player.name)}
                  disabled={redTeam.includes(player.name)}
                  onchange={() => toggleBlue(player.name)}
                />
                {player.name}
              </label>
            {/each}
          ...
          <div class="team">
            ...
            {#each players as player}
              <label>
                <input
                  type="checkbox"
                  checked={redTeam.includes(player.name)}
                  disabled={blueTeam.includes(player.name)}
                  onchange={() => toggleRed(player.name)}
                />
                {player.name}
              </label>
            {/each}
